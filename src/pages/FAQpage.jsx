  ...
  return (
    <>
      ...
      <nav className="faq-nav">
        <Link to="/" className="faq-nav-btn">← Home</Link>
        <Link to="/gallery" className="faq-nav-btn">Gallery</Link>
        <Link to="/clubs" className="faq-nav-btn">Clubs</Link>
      </nav>
      <main>
        <section className="faq-section">
          ...
          <div className="faq-inner">
            ...
            <div className="faq-footer">
              ...
              <Link to="/#contact" className="primary-button faq-cta">
                Ask the seniors!
              </Link>
            </div>
          </div>
